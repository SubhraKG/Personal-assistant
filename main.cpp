...
void greetings(){
    ...
    if (time-> tm_hour < 12){
        cout<< "Good Morning Subhra"<<endl;
        string phrase = "Good Morning Subhra";
        ...
        cout<< "Good Afternoon Master Subhra"<<endl;
        string phrase = "Good Afternoon Subhra";
        string command = "espeak \"" + phrase + "\"";
        const char *charCommand = command.c_str();
        system(charCommand);
    }
        ...
        cout<< "Good Evening Subhra"<<endl;
        string phrase = "Good Evening Subhra";
        string command = "espeak \"" + phrase + "\"";
        const char *charCommand = command.c_str();
        system(charCommand);
    }
...
int main()
{
    ...
    string command; //  command from the user

    do
    {
        cout<<"******************************************************"<<endl;
        cout<<"| ENTER THE PASSWORD TO CONFIRM YOU ARE SUBHRA|"<<endl;
        cout<<"******************************************************"<<endl<<endl;
        string phrase = "ENTER THE PASSWORD TO CONFIRM YOU ARE SUBHRA";
        string command = "espeak \"" + phrase + "\"";
        const char *charCommand = command.c_str();
        system(charCommand);
        ...
        if(password=="subhra")
        {
            ...
            do{
                cout<<"\n<**********************************************************************************************>\n\n";
                cout<<endl<<"How can i help you Subhra...."<<endl<<endl;

                string phrase = "How can i help you Subhra";
                string command = "espeak \"" + phrase + "\"";
                const char *charCommand = command.c_str();
                system(charCommand);
                ...
                {
                    cout<<"Hello Subhra....."<<endl;
                    string phrase = "Hello Subhra";
                    string command = "espeak \"" + phrase + "\"";
                    const char *charCommand = command.c_str();
                    system(charCommand);
                }
                ...
                {
                    cout<<"I'm a personal assistant created by Subhra !!!"<<endl;
                    string phrase = "I'm a personal assistant created by Subhra !!!";
                    string command = "espeak \"" + phrase + "\"";
                    const char *charCommand = command.c_str();
                    system(charCommand);
                }
               ...
               else if(command=="open avengers photo")
                {
                    cout<<"opening photo"<<endl;
                    string phrase = "opening avengers photo";
                    string command = "espeak \"" + phrase + "\"";
                    const char *charCommand = command.c_str();
                    system(charCommand);
                ...
                else if(command=="bye" || command=="exit" || command=="thank you, thats it")
                {
                    cout<<"Good Bye Master Subhra, see you soon!"<<endl;
                    string phrase = "Good Bye Master Subhra, see you soon!";
                    string command = "espeak \"" + phrase + "\"";
                    const char *charCommand = command.c_str();
                    system(charCommand);
                    exit(0);
        ...
        else
                {
                    ...
                    string phrase = "Incorrect Password, please enter correct password , hint!!!!! something involving your name !!!!! ";
                    string command = "espeak \"" + phrase + "\"";
                    const char *charCommand = command.c_str();
                    system(charCommand);
                }
